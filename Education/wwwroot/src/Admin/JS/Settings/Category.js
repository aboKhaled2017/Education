...
var CategoryBtnText;
(function (CategoryBtnText) {
    CategoryBtnText["activate"] = "\u062A\u0641\u0639\u064A\u0644";
    CategoryBtnText["deActivate"] = "\u062A\u0639\u0637\u064A\u0644";
...
var ToggleBtn = function (record) {
    ...
    return $("<i class=\"controlBtn toogleBtn fa fa-2x " + btnClass + "\" title=\"" + btnText + "\"></i>");
};
var languages = {
    search: "بحث",
