...
var playItem = function playItem(player, item) {
    ...
    if (item.description)
        $(player.el()).find('#subPlayerSection>p#descEl').text(item.description);
    return player;
};
/**
...
function factory(player, initialList, initialIndex) {
    ...
    playlist.repeat = function (val) {
        ...
        if (typeof val !== 'boolean') {
            video_js_1.default.log.error('videojs-playlist: Invalid value for repeat', val);
            return;
        }
    ...
    playlist.shuffle = function (_temp) {
        var _ref = _temp === void 0 ? {} : _temp, rest = _ref.rest;
        var index = 0;
        ...
        if (rest) {
            var _list;
            (_list = list).splice.apply(_list, [index, arr.length])
                .concat(arr);
...
var version = "4.2.6";
var registerPlugin = video_js_1.default.registerPlugin || video_js_1.default.plugin;
/**
...
//# sourceMappingURL=videojsPlaylist.js.map